...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/actions-includes-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12725&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/actions-includes-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `actions-includes` can be installed with:

```
conda install actions-includes
```

It is possible to list all of the versions of `actions-includes` available on your platform with:
